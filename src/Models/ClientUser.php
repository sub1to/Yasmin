...
class ClientUser extends User {
    ...
    function setAvatar(?string $avatar) {
        ...
        return (new Promise(function (callable $resolve, callable $reject) use ($avatar) {
            FileHelpers::resolveFileResolvable($avatar)->done(function ($data) use ($resolve, $reject) {
    ...
    function createGroupDM(array $userWithAccessTokens, array $nicks = array()) {
        return (new Promise(function (callable $resolve, callable $reject) use ($nicks, $userWithAccessTokens) {
            $tokens = array();
            $users = array();
